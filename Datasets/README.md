## Datasets allowing to plot the Figure 1 and to create the inputs of the low-dimensionnal model

### Datasets from Burgard et al, 2022
...
- nemo_5km_isf_masks_and_info_and_distance_new_oneFRIS.nc (too big for GitHub, available at https://doi.org/10.5281/zenodo.15855346)
- T_S_mean_prof_corrected_km_contshelf_and_offshore_1980-2018_oneFRIS.nc (too big for GitHub, available at https://doi.org/10.5281/zenodo.15855346)
- nemo_5km_boxes_1D_oneFRIS.nc
- nemo_5km_boxes_2D_oneFRIS.nc
...
- ice_prod_5km_Nakata.nc (too big for GitHub, available at https://doi.org/10.5281/zenodo.15855346)
...
### Datasets from Morlighem et al, 2019
